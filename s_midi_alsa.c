...
#ifndef ALSA_MAX_EVENT_SIZE           // vp 06.jan.2013
#define ALSA_MAX_EVENT_SIZE 512       //  vp 06.jan.2013
#endif                                // vp 06.jan.2013
    ...
    int nmidiout, int *midioutvec)
{
    ...
    sys_setalarm(0);
//    snd_midi_event_new(20,&midiev);                 // vp 06.jan.2013
    snd_midi_event_new(ALSA_MAX_EVENT_SIZE,&midiev);  // vp 06.jan.2013
...
{
//   unsigned char buf[20];             // vp 06.jan.2013
   unsigned char buf[ALSA_MAX_EVENT_SIZE];               // vp 06.jan.2013
   ...
   if (midievent != NULL)
   {
//       count = snd_midi_event_decode(midiev,buf,20,midievent);          // vp 06.jan.2013
       count = snd_midi_event_decode(midiev,buf,sizeof(buf),midievent);   // vp 06.jan.2013
